...
namespace Flowly.Infrastructure.Migrations
{
    ...
    [Migration("20251029113555_InitialCreate")]
            ...
            modelBuilder.Entity("Flowly.Domain.Entities.Category", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("1346525b-83b1-4085-9289-c12d118d2ef6"),
                            Name = "Food & Drinks"
                        },
                        new
                        {
                            Id = new Guid("0239502c-e983-49f1-a554-3ea1d55e7041"),
                            Name = "Transport"
                        },
                        new
                        {
                            Id = new Guid("c8d4d6cb-27f6-40fa-8654-43d71405e2b9"),
                            Name = "Shopping"
                        },
                        new
                        {
                            Id = new Guid("db56ea0a-3003-4a1a-a2eb-92c245db4d15"),
                            Name = "Entertainment"
                        },
                        new
                        {
                            Id = new Guid("d8de97bc-f50a-4bd1-935a-73b8dd15fa4c"),
                            Name = "Health"
                        },
                        new
                        {
                            Id = new Guid("bcdc067d-be4f-4c6e-8854-bdec2e5b22ab"),
                            Name = "Education"
                        },
                        new
                        {
                            Id = new Guid("9152637d-2d4f-4d5d-b81b-f86402a1db6b"),
                            Name = "Utilities"
                        },
                        new
                        {
                            Id = new Guid("827992c7-0617-434f-b25f-207979536ec9"),
                            Name = "Salary"
                        },
                        new
                        {
                            Id = new Guid("5b0b51f3-e0ea-46c9-a5df-d690b8885608"),
                            Name = "Freelance"
                        },
                        new
                        {
                            Id = new Guid("2baa6ecb-b24c-4b6a-9095-0e438dbfab51"),
                            Name = "Other"
                        });
                });
